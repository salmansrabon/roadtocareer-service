...
const sendMail = async (params) => {
  try {
    ...
    // if (params.type.trim() == 'sendPass') {
    //   console.log('##################################' + params.type === 'sendPass')
    //   const info = await transporter.sendMail(options);
    //   console.log("Credential sent to student: " + info.response); // Log the response after sending mail
    ...
    console.error(error);
    console.error("General error in sendMail function:", error);
  }
};
